...
import { UpdateChatbotPayload, ThemeConfig, Chatbot, EnhancedThemeConfig, DefaultTheme, UserCustomTheme, CreateCustomThemePayload } from '@/app/dashboard/libs/queries';
...
import { Sun, Moon, Star, Copy, Trash2, Palette, Edit, UserCircle2, MessageSquareText, BadgeDollarSign, GripVertical } from 'lucide-react';
