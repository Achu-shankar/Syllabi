...
function PureMultimodalInput({
  ...
  const submitForm = useCallback(() => {
    ...
    // Submit the form with any configured body parameters (including chatbotSlug)
    ...
    >
      ...
      */}
      ...
      <Textarea
        ...
        className={cx(
          'min-h-[24px] max-h-[calc(75dvh)] overflow-hidden resize-none rounded-2xl shadow-md !text-base pb-10 w-full',
          className,
        )}
        style={{
