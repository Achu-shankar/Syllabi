...
export const SendIcon = ({ size = 16, ...props }: LucideProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={size}
...
export const DocIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <rect x="2" y="1" width="10" height="14" rx="1" fill="#71717a" stroke="#71717a" strokeWidth="0.5"/>
    <path d="M11 1L14 4V14C14 14.5523 13.5523 15 13 15H12V4H11V1Z" fill="#52525b"/>
    <text x="7" y="9.5" fontSize="4" fill="white" textAnchor="middle" fontWeight="bold" fontFamily="Arial, sans-serif">
      DOC
    </text>
  </svg>
);
