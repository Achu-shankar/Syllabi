 ...
 */
function getNotionAccessToken(integrationId) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase.rpc('decrypt_notion_access_token', {
 ...
 */
function createNotionClient(integrationId) {
    return __awaiter(this, void 0, void 0, function () {
        var accessToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getNotionAccessToken(integrationId)];
                case 1:
                    accessToken = _a.sent();
                    return [2 /*return*/, new client_1.Client({ auth: accessToken })];
            }
        });
    });
}
